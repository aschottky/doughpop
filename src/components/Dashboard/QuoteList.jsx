...
const DEMO_QUOTES = [
  { id: '1', quote_number: 'Q-0001', clients: { first_name: 'Sarah', last_name: 'Thompson' }, title: 'Wedding cake & cookies', total: 545, status: 'sent', valid_until: '2026-03-20', created_at: new Date().toISOString() },
  { id: '2', quote_number: 'Q-0002', clients: { first_name: 'Mike', last_name: 'Jenkins' }, title: 'Birthday party order', total: 220, status: 'accepted', valid_until: '2026-03-15', created_at: new Date(Date.now() - 86400000).toISOString() },
  { id: '3', quote_number: 'Q-0003', clients: null, title: 'Custom cake tasting', total: 95, status: 'draft', valid_until: null, created_at: new Date(Date.now() - 172800000).toISOString() },
  { id: '4', quote_number: 'Q-0004', clients: { first_name: 'Emma', last_name: 'Clark' }, title: 'Baby shower dessert table', total: 680, status: 'converted', valid_until: '2026-02-28', created_at: new Date(Date.now() - 604800000).toISOString() },
]

export default function QuoteList() {
  const navigate = useNavigate()
  const { getQuotes, deleteQuote } = useData()
